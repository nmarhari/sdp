...
import { StyleSheet, View, Text, Image, Dimensions, Button ,ScrollView} from "react-native";
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <Button title="Choose a photo" onPress={() => photoPickerRef.current.openImagePicker()} />
      </View>
      <PhotoPickerSection ref={photoPickerRef} />
